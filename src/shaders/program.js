...
export class Program {
    ...
    createProgram(vertexShaderSourceCode, fragmentShaderSourceCode) {
        ...
        if (!this.gl.getProgramParameter(this.program, this.gl.LINK_STATUS)) {
            ...
            this.cameraDirectionUniform = this.gl.getUniformLocation(this.program, 'camera.direction');
            ...
            this.lightTypeUniform = this.gl.getUniformLocation(this.program, 'lightType');
        }
    }
    ...
    setUniformStructs(coefficient, camera, light) {
        ...
        this.gl.uniform3fv(this.cameraDirectionUniform, camera.getDirection());
        ...
        this.gl.uniform3fv(this.lightDirectionUniform, light.getDirection());
    }
    ...
    setUniformLight(lightType) {
        this.gl.uniform1i(this.lightTypeUniform, lightType);
    }
}
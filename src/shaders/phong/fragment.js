export const phongFragmentShaderSourceCode = `#version 300 es
...
uniform mat3 normalMatrix;  // inverseTranspose(mat3(camera.view * transformationMatrix))
...
void main() {
    outputColor = vec4(computeFinalColor(fragmentPosition, fragmentColor, fragmentNormal), 1.);
}`;